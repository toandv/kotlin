...
public class ExpressionTypingServices {
    ...
    public KotlinType getBodyExpressionType(
        ...
        KotlinResolutionCallbacksImpl.LambdaInfo lambdaInfo = getNILambdaInfoForAnonimousFunction(context, function);
        ...
        updateLambdaContextInfoForAnonimousFunction(lambdaInfo, typeInfo, context);
    ...
    private static void updateLambdaContextInfoForAnonimousFunction(
    ...
    @Nullable
    public static KotlinResolutionCallbacksImpl.LambdaInfo getNILambdaInfoForAnonimousFunction(
            @NotNull ExpressionTypingContext context,
